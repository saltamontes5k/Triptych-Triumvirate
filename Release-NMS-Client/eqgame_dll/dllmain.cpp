...
bool WINAPI DllMain(HMODULE hModule, DWORD dwReason, LPVOID lpReserved)
{
	...
	case DLL_PROCESS_ATTACH:
		// Fix working directory: when launched from Windows Search, shortcuts without
		// "Start In", or any launcher that doesn't set CWD, EQ fails to find its UI files,
		// zones, sounds etc. because they all use relative paths. Force CWD to the exe folder.
		{
