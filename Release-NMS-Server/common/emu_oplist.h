...
// shroud opcodes: native RoF2 client opcodes (see utils/scripts/opcode_scripts/opcodelist.txt)
N(OP_Shroud),
N(OP_ShroudSelectionWindow),
N(OP_ShroudRequestStats),
N(OP_ShroudRespondStats),
N(OP_ShroudSelect),
N(OP_ShroudSelectCancel),
N(OP_ShroudProgress),
