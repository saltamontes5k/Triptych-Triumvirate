...
function event_trade(e)
    ...
    if e.other:IsTaskActivityActive(612004,6) then -- Frostfell A Gift for Tinam task activity 6 active
        if item_lib.check_turn_in(e.trade, {item1 = 87544}) then -- Morky's Spear
			...
			e.other:UpdateTaskActivity(612004,6,1); -- Frostfell A Gift for Tinam task activity 6 complete
