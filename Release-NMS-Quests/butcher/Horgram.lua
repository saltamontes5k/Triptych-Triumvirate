...
function event_trade(e)
    ...
    if e.other:IsTaskActivityActive(612004,8) then -- Frostfell A Gift for Tinam task activity 8 active
        if item_lib.check_turn_in(e.trade, {item1 = 87542}) then -- Lock of Hagbletha's Hair
			...
			e.other:UpdateTaskActivity(612004,8,1); -- Frostfell A Gift for Tinam task activity 8 complete
