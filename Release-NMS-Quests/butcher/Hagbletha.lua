...
function event_trade(e)
    ...
    if e.other:IsTaskActivityActive(612004,7) then -- Frostfell A Gift for Tinam task activity 7 active
        if item_lib.check_turn_in(e.trade, {item1 = 87543}) then -- Firin's Bear Skin Cloak
			...
			e.other:UpdateTaskActivity(612004,7,1); -- Frostfell A Gift for Tinam task activity 7 complete
