...
function event_say(e)
  if not prog.gate_stage(e.other, "DoN", "Scout Miigle says, 'I am sorry, friend. The Wayfarers will open these dungeons only to those who have toppled the elemental gods of the planes.'") then
    return
  end
