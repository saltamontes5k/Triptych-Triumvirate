-- Encounter: LDoN Raid: The Rujarkian Hills: Drudge Hollows
-- Zone: ruje / version 50. Cast reused from rujd v50, placed at map-derived interior points.
local boss_down = false;

function Boss_Death(e)
  if boss_down then return end
  boss_down = true;
  eq.zone_emote(MT.Yellow, "Taskmaster Dokorel is slain. The drudges of the hollows raise their heads at last.");
...
function event_encounter_load(e)
  eq.register_npc_event('ruje', Event.death_complete, 245199, Boss_Death);
end
