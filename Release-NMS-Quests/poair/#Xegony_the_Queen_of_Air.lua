...
function event_combat(e)
	if e.joined then
		...
		eq.set_timer("Reset", 30 * 1000) -- 30 Seconds
	end
end
...
function help_xegony(e)
	...
	for npc in npc_list.entries do
		if 
			npc.valid and
			(
				npc:GetNPCTypeID() == 215434 or
				npc:GetNPCTypeID() == 215437 or
				npc:GetNPCTypeID() == 215440 or
				npc:GetNPCTypeID() == 215444 or
				npc:GetNPCTypeID() == 215445 or
				npc:GetNPCTypeID() == 215462 or
				npc:GetNPCTypeID() == 215463 or
				npc:GetNPCTypeID() == 215464 or
				npc:GetNPCTypeID() == 215465 or
				npc:GetNPCTypeID() == 215466 or
				npc:GetNPCTypeID() == 215472 or
				npc:GetNPCTypeID() == 215479
			)
		 then
