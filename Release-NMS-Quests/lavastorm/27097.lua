-- Dragons of Norrath camp NPC (npc id 27097)
-- Active v0 copy of upstream lavastorm/v1/Commander_Zaerr_Ty-Dar.lua
...
local function don_deny(e)
  return not nms.gate_stage(e.other, "DoN", "Commander Zaerr Ty`Dar says, \'The Dark Reign has no use for the unproven, outsider. Return once you have toppled the elemental gods of the planes.\'")
end
