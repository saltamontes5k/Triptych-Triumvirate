-- Dragons of Norrath camp NPC (npc id 27098)
-- Active v0 copy of upstream lavastorm/v1/Chieftain_Relae_Aderi.lua
...
local function don_deny(e)
  return not nms.gate_stage(e.other, "DoN", "Chieftain Relae Aderi says, \'Norrath\'s Keepers cannot yet entrust this work to you, friend. Return once you have proven yourself against the elemental gods of the planes.\'")
end
