-- Dragons of Norrath camp NPC (npc id 27093)
-- Active v0 copy of upstream lavastorm/v1/General_Lereh_Dirr.lua
...
local function don_deny(e)
  return not nms.gate_stage(e.other, "DoN", "General Lereh Dirr says, \'The Dark Reign has no use for the unproven, outsider. Return once you have toppled the elemental gods of the planes.\'")
end
