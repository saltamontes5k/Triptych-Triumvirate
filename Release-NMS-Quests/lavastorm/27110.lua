-- Dragons of Norrath camp NPC (npc id 27110)
-- Active v0 copy of upstream lavastorm/v1/#Tatsujiro_the_Serene.lua
...
local function don_deny(e)
  return not nms.gate_stage(e.other, "DoN", "Tatsujiro the Serene says, \'Norrath\'s Keepers cannot yet entrust this work to you, friend. Return once you have proven yourself against the elemental gods of the planes.\'")
end
