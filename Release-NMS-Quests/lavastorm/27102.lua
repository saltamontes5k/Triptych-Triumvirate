-- Dragons of Norrath camp NPC (npc id 27102)
-- Active v0 copy of upstream lavastorm/v1/Captain_Areha_Burina.lua
...
local function don_deny(e)
  return not nms.gate_stage(e.other, "DoN", "Captain Areha Burina says, \'Norrath\'s Keepers cannot yet entrust this work to you, friend. Return once you have proven yourself against the elemental gods of the planes.\'")
end
