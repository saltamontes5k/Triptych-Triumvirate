-- Dragons of Norrath camp NPC (npc id 27095)
-- Active v0 copy of upstream lavastorm/v1/Officer_Vacax_Rol-Tas.lua
...
local function don_deny(e)
  return not nms.gate_stage(e.other, "DoN", "Officer Vacax Rol`Tas says, \'The Dark Reign has no use for the unproven, outsider. Return once you have toppled the elemental gods of the planes.\'")
end
