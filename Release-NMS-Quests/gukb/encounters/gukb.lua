-- Encounter: LDoN Raid: Deepest Guk: The Drowning Crypt
-- Zone: gukb / version 50. Cast reused from gukc, placed at map-derived interior points.
local boss_down = false;

function Boss_Death(e)
  if boss_down then return end
  boss_down = true;
  eq.zone_emote(MT.Yellow, "The Lich of the Drowning Crypt is destroyed. The waters fall still.");
...
function event_encounter_load(e)
  eq.register_npc_event('gukb', Event.death_complete, 239289, Boss_Death);
end
