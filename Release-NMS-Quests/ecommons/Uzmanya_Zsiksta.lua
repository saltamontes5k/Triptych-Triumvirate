...
function event_say(e)
  if not prog.gate_stage(e.other, "DoN", "Uzmanya Zsiksta says, 'The Wayfarers will open these hills only to those who have toppled the elemental gods of the planes.'") then
    return
  end
