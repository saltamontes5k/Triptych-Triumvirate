local rujj = {
  ...
  instance   = { zone="rujj", version=0, duration=eq.seconds("3h") },
...
function event_say(e)
  ...
  end  if not prog.gate_stage(e.other, "DoN", "Uzmanya Zsiksta says, 'The Wayfarers will open these dungeons only to those who have toppled the elemental gods of the planes.'") then
    return
  end
