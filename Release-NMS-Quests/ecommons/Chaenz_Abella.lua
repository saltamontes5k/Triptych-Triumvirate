...
function event_say(e)
  ...
  end  if not prog.gate_stage(e.other, "DoN", "Chaenz Abella says, 'The Wayfarers will open these dungeons only to those who have toppled the elemental gods of the planes.'") then
    return
  end
