local gukc = {
  ...
  instance   = { zone="gukc", version=1, duration=eq.seconds("3h") },
...
function event_say(e)
  ...
  end  if not prog.gate_stage(e.other, "DoN", "Scout Miigle says, 'I am sorry, friend. The Wayfarers will open these dungeons only to those who have toppled the elemental gods of the planes.'") then
    return
  end
  ...
  elseif e.message:findi("interested") then
    eq.get_entity_list():MessageClose(e.self, true, 100, MT.SayEcho, "Scout Miigle says, 'I hope to see Bidip Moktu again soon, and in one piece.'")
