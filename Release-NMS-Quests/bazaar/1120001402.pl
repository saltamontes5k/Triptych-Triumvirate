# 1120001402 - Taelosian_Petitioner (Discord Key) - Bazaar v0
...
sub EVENT_SAY {
    if ($text =~ /hail/i) {
        ...
        plugin::NPCTell("I am a Taelosian petitioner, keeper of the Discord records. Your progress against the gates of Discord and the Omens of War is as follows:");
