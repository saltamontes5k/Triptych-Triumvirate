...
sub EVENT_SAY {
    ...
    if ($text =~ /hail/i) {
        ...
        $response = "In exchange for a number of [Triune of Fate], I can enchant the entire world! Each should co-exist with over versions of this type of effect, and will last four hours. 
                     ...
                     In order to enhance [Experience Gain] or [Movement Speed], I will require five tokens of the Triune's favor. 
                     Enhancement of [Overall Power] will cost 20 tokens. 
                     For merely ten Tokens, I can [influence the tides of fate] in order to increase the rate that adventurers find rare items in the world!
                     Alternatively, for thirty-five Tokens, I can cast [all of these enchantments]!";
    }
    ...
    if (@buffs && $cost) {
        if (plugin::SpendTriuneOfFate($client, $cost)) {
