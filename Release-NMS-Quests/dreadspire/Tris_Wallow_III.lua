--[[
	Tris_Wallow_III (900206) - Demi-Plane of Blood (dreadspire, version 1)
	Depths of Darkhollow raid encounter - functional baseline.
]]

local BOSS_ID = 900206
local EVENT   = "Tris Wallow III"
...
function event_hp(e)
	if e.hp_event == 66 then
		e.self:Emote("calls her retinue of evil elements.")
		spawn_add(e, 2, 35)
		eq.set_next_hp_event(33)
	elseif e.hp_event == 33 then
		e.self:Emote("unleashes a cruel manipulation, dark power swirling.")
		spawn_add(e, 3, 40)
...
function event_death_complete(e)
	...
	eq.zone_emote(MT.Yellow, "Tris Wallow III's cruel song falls silent.")
end
