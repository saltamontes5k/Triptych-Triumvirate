...
sub EVENT_ITEM
{
	if (quest::handin({ 61181 => 1, 61182 => 1, 61183 => 1, 61184 => 1 })) { # Shai`Din Longsword Left Hilt , Shai`Din Longsword Right Hilt , Dulled Shai`Din Longsword Blade, Runed Shai`Din Blade Edge
  ...
  if (quest::handin({ 61193 => 1 })) { # Blood of the Royals 
