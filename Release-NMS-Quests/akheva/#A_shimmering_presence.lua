---- Quest:Key to Vex Thal

function event_say(e)
	if e.message:findi("hail") then
		e.self:Emote("'s voice invades your mind, drawing images of past present and future together into a perverse harmony. Some images you recognize as your own, but the others seem to be coming from the spirit's own [" .. eq.say_link("memories") .. "].");
	elseif e.message:findi("memories") then
		e.self:Emote(" begins to glow a bit brighter. Your mind is filled with visions of a great swirl of clouds and lightning. You can almost feel the wind of the storm creeping into the chinks in your armor. It looks as if the storm is creeping across the surface of Luclin. You see several figures standing at the entrance of a [" .. eq.say_link("great temple") .. "]. The storm seems to be bearing down on them.");
	elseif e.message:findi("great temple") then
		e.self:Emote(" continues to flood your mind with images of the storm bearing down on the temple. Your view suddenly shifts. You're still looking at the storm, but it appears to be moving toward you this time. There is a creature beside you wearing a robe, holding a scepter in one of his...four arms! He is obviously the leader of the group, As he is wearing beautiful [" .. eq.say_link("ornate robes") .. "] compared to the rest of the four armed figures around you.");
...
function event_trade(e)
	...
	if item_lib.check_turn_in(e.trade, {item1 = 10294}) then -- Item: Summoned: Wisp Stone
