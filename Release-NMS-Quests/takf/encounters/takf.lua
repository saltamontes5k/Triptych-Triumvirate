-- Encounter: LDoN Raid: Takish-Hiz: Sandfall Corridors
-- Zone: takf / version 50. Cast reused from taka, placed at map-derived interior points.
local boss_down = false;

function Boss_Death(e)
  if boss_down then return end
  boss_down = true;
  eq.zone_emote(MT.Yellow, "The Jeweled Guard hero falls. The corridors of Takish-Hiz quiet.");
...
function event_encounter_load(e)
  eq.register_npc_event('takf', Event.death_complete, 231748, Boss_Death);
end
