...
sub EVENT_SAY {
  ...
  if($text=~/familiar with the Plane of Hate/i) {
  ...
  if(($text=~/interest/i) && ((plugin::HasClassName($client, "Cleric")) || (plugin::HasClassName($client, "Shaman")) || (plugin::HasClassName($client, "Druid")))) {
  ...
  if(($text=~/interest/i) && ((plugin::HasClassName($client, "Warrior")) || (plugin::HasClassName($client, "Rogue")) || (plugin::HasClassName($client, "Monk")))) {
...
sub EVENT_ITEM {
    ...
    if (plugin::is_stage_complete($client, 'RoK', 1)) {
      ...
      if (plugin::check_handin(\%itemcount, 54051 => 1, 54034 => 1)) { # melee 3
          quest::summonitem(54051);
          quest::summonitem(54034);
          quest::emote("looks at you closely...");
          quest::say("You don't look experienced enough to help me with this yet, come back once you have defeated the vile dragons that terrorize these lands.");
          return;
      }
      if (plugin::check_handin(\%itemcount, 54043 => 1, 54028 => 1)) { # priest 3
          quest::summonitem(54043);
          quest::summonitem(54028);
          quest::emote("looks at you closely...");
          quest::say("You don't look experienced enough to help me with this yet, come back once you have defeated the vile dragons that terrorize these lands.");
          return;
      }
      if (plugin::check_handin(\%itemcount, 54035 => 1, 54058 => 1, 54060 => 1, 54056 => 1)) { # melee 4
          quest::summonitem(54035);
