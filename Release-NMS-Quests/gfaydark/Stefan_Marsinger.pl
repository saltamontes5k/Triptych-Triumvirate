...
sub EVENT_SAY {
    ...
    if (($text=~/work/i) && ((plugin::HasClassName($client, "Ranger")) || (plugin::HasClassName($client, "Paladin")) || (plugin::HasClassName($client, "Shadowknight")) || (plugin::HasClassName($client, "Beastlord")) || (plugin::HasClassName($client, "Bard")))) {
    ...
    if (($text=~/work/i) && ((plugin::HasClassName($client, "Wizard")) || (plugin::HasClassName($client, "Magician")) || (plugin::HasClassName($client, "Necromancer")) || (plugin::HasClassName($client, "Enchanter")))) {
    ...
    if (($text=~/work/i) && ((plugin::HasClassName($client, "Cleric")) || (plugin::HasClassName($client, "Shaman")) || (plugin::HasClassName($client, "Druid")) || (plugin::HasClassName($client, "Warrior")) || (plugin::HasClassName($client, "Rogue")) || (plugin::HasClassName($client, "Monk")))) {
        quest::say("Please speak to my sister, Seana, for further information. She will be your primary contact for any tasks you perform for us in Innoruuk's realm. The League of Antonican Bards and I commend you for your efforts.");
        return
    }
    if (plugin::is_stage_complete($client, 'RoK', 1)) {
        if (($text=~/final task/i) && ((plugin::HasClassName($client, "Ranger")) || (plugin::HasClassName($client, "Paladin")) || (plugin::HasClassName($client, "Shadowknight")) || (plugin::HasClassName($client, "Beastlord")) || (plugin::HasClassName($client, "Bard")))) {
        ...
        if (($text=~/final task/i) && ((plugin::HasClassName($client, "Wizard")) || (plugin::HasClassName($client, "Magician")) || (plugin::HasClassName($client, "Necromancer")) || (plugin::HasClassName($client, "Enchanter")))) {
        ...
        if (($text=~/final task/i) && ((plugin::HasClassName($client, "Cleric")) || (plugin::HasClassName($client, "Shaman")) || (plugin::HasClassName($client, "Druid")) || (plugin::HasClassName($client, "Warrior")) || (plugin::HasClassName($client, "Rogue")) || (plugin::HasClassName($client, "Monk")))) {
            quest::say("Please speak to my sister, Seana, for further information. She will be your primary contact for any tasks you perform for us in Innoruuk's realm. The League of Antonican Bards and I commend you for your efforts.");
            return;
        }
    }
    elsif ($text=~/final task/i) {
        quest::emote("looks at you closely...");
        quest::say("You don't look experienced enough to help me with this yet, come back once you have defeated the vile dragons that terrorize these lands.");
        return;
    }
}
...
sub EVENT_ITEM {
    ...
    else {  # This is really ugly but we want to check to see if they handed in the items and then return them if they are not in ROK yet and since we consume them as part of the valid handing check, we want to resummon them back
        if (plugin::check_handin(\%itemcount, 54037 => 1, 54047 => 1)) { # caster 3
            quest::summonitem(54037);
            quest::summonitem(54047);
            quest::emote("looks at you closely...");
            quest::say("You don't look experienced enough to help me with this yet, come back once you have defeated the vile dragons that terrorize these lands.");
            return;
        }
        if (plugin::check_handin(\%itemcount, 54031 => 1, 54055 => 1)) { # hybrid 3
            quest::summonitem(54031);
            quest::summonitem(54055);
            quest::emote("looks at you closely...");
            quest::say("You don't look experienced enough to help me with this yet, come back once you have defeated the vile dragons that terrorize these lands.");
            return;
        }
        if (plugin::check_handin(\%itemcount, 54058 => 1, 54060 => 1, 54056 => 1, 54032 => 1)) { # hybrid 4
            quest::summonitem(54058);
            quest::summonitem(54060);
            quest::summonitem(54056);
            quest::summonitem(54032);
            quest::emote("looks at you closely...");
            quest::say("You don't look experienced enough to help me with this yet, come back once you have defeated the vile dragons that terrorize these lands.");
            return;
        }
        if (plugin::check_handin(\%itemcount, 54038 => 1, 54059 => 1, 54057 => 1, 54061 => 1)) { # caster 4
            quest::summonitem(54038);
            quest::summonitem(54059);
            quest::summonitem(54057);
            quest::summonitem(54061);
            quest::emote("looks at you closely...");
            quest::say("You don't look experienced enough to help me with this yet, come back once you have defeated the vile dragons that terrorize these lands.");
            return;
        }
