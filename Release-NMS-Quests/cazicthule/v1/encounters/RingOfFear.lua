local GOVERNOR_TYPE = 1500000051;		-- using 'InterpreterZero' for this, but can be anything that's always up
local HIGH_PRIEST_TYPE = 1500000031;
local WARDER_TYPE = 1500000036;
local GUARD_KHATARUSS_TYPE = 1500000164;
local GUARD_THRASCISS_TYPE = 1500000166;
local GUARD_SCITHISS_TYPE = 1500000165;
local TAHIA_TYPE = 1500000009;
local UNSTABLE_RIFT_TYPE = 1500000172;
local JUSTICAR_TYPE = 1500000001;
local FAKE_DREAD_TYPE = 1500000173;
local FAKE_FEAR_TYPE = 1500000174;
local FAKE_FRIGHT_TYPE = 1500000175;
local FAKE_TERROR_TYPE = 1500000176;
local REAL_DREAD_TYPE = 1500000160;
local REAL_FEAR_TYPE = 1500000163;
local REAL_FRIGHT_TYPE = 1500000161;
local REAL_TERROR_TYPE = 1500000162;
local AMYGDALAN_KNIGHT_TYPE = 1500000157;
local GORGON_TYPE = 1500000144;
local SHIVERBACK_TYPE = 1500000146;
local SPINECHILLER_TYPE = 1500000147;
local TENTACLE_TYPE = 1500000149;
...
local TAHIA_SPAWNID = 40000005;
local JUSTICAR_SPAWNIDS = { [40000001] = 1, [40000002] = 1, [40000003] = 1, [40000004] = 1 };
...
function TahiaTradeEvent(e)
	...
	if ( item_lib.check_turn_in(e.trade, {item1 = 8234}) ) then -- Rune of the Faceless
...
function event_encounter_load(e)
	...
	eq.register_npc_event("RingOfFear", Event.death, REAL_FEAR_TYPE, function() eq.depop_all(TAHIA_TYPE); eq.add_expedition_lockout_all_clients("Revamped Cazic Thule", "Ring of Fear", 86400); end);
