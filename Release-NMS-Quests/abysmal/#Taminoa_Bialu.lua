...
function event_say(e)
  if e.other:IsTaskCompleted(task_ids.bic_abysmal) or (e.other:IsTaskCompleted(task_ids.bic_qinimi) and e.other:IsTaskCompleted(task_ids.bic_barindu) and e.other:IsTaskCompleted(task_ids.bic_riwwi) and e.other:IsTaskCompleted(task_ids.bic_ferubi)) then
  ...
  elseif not e.other:IsTaskActive(task_ids.bic_abysmal) then
    ...
    if e.message:findi('qinimi') and not e.other:IsTaskActive(task_ids.bic_qinimi) and not e.other:IsTaskCompleted(task_ids.bic_qinimi) then
      ...
      e.other:AssignTask(task_ids.bic_qinimi)
    end
    ...
    if e.message:findi('ferubi') and not e.other:IsTaskActive(task_ids.bic_ferubi) and not e.other:IsTaskCompleted(task_ids.bic_ferubi) then
      ...
      e.other:AssignTask(task_ids.bic_ferubi)
    end
    if e.message:findi('riwwi') and not e.other:IsTaskActive(task_ids.bic_riwwi) and not e.other:IsTaskCompleted(task_ids.bic_riwwi) then
      ...
      e.other:AssignTask(task_ids.bic_riwwi)
    end
    if e.message:findi('barindu') and not e.other:IsTaskActive(task_ids.bic_barindu) and not e.other:IsTaskCompleted(task_ids.bic_barindu) then
      ...
      e.other:AssignTask(task_ids.bic_barindu)
    end
  end
end
...
function event_trade(e)
  ...
  if item_lib.check_turn_in(e.trade, {item1 = 67511}) then --Xictic's Bloody Robes
    ...
    e.other:UpdateTaskActivity(task_ids.bic_abysmal, 0, 1)
  end
  ...
  if item_lib.check_turn_in(e.trade, {item1 = 67520}) then --Sealed Report
    ...
    e.other:UpdateTaskActivity(task_ids.bic_ferubi, 1, 1)
  end
  ...
  if item_lib.check_turn_in(e.trade, {item1 = 67526}) then --Rondo's Report
    ...
    e.other:UpdateTaskActivity(task_ids.bic_abysmal, 3, 1)
  end
  ...
  if item_lib.check_turn_in(e.trade, {item1 = 67417}) then --Reyna's Scout Report
    ...
    e.other:UpdateTaskActivity(task_ids.bic_abysmal, 2, 1)
  end
  ...
  if item_lib.check_turn_in(e.trade, {item1 = 67516}) then --Talwin's Final Journal
    ...
    e.other:UpdateTaskActivity(task_ids.bic_abysmal, 1, 1)
  end
