local taka = {
  ...
  safereturn = { zone="northro", x=-1252, y=5548, z=28.25, h=0 } -- made up, live uses northro
  -- compass    = { zone="northro", x=-1187.608, y=5567.216, z=12.897 },
...
function event_say(e)
  ...
  end  if not prog.gate_stage(e.other, "DoN", "Tarakix V`Rasyrn glares at you. 'You are not ready. Prove yourself against the elemental gods of the planes before the Wayfarers trust you here.'") then
    return
  end
