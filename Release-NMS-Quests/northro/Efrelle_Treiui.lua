...
function event_say(e)
  ...
  end  if not prog.gate_stage(e.other, "DoN", "Efrelle Treiui says, 'The Wayfarers will open these ruins only to those who have toppled the elemental gods of the planes.'") then
    return
  end
