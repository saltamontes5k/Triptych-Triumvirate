...
function event_say(e)
  if not prog.gate_stage(e.other, "DoN", "Dizzl Nulzik says, 'Oh my, not yet! The Wayfarers will open these ruins only to those who have toppled the elemental gods of the planes.'") then
    return
  end
