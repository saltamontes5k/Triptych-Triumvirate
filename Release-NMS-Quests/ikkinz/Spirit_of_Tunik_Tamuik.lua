...
function event_say(e)
	...
	if(e.message:findi("hail")) then
		...
		if not el:IsMobSpawnedByNpcTypeID(294574) and not el:IsMobSpawnedByNpcTypeID(294575) and not el:IsMobSpawnedByNpcTypeID(294339) and not el:IsMobSpawnedByNpcTypeID(294338) and not el:IsMobSpawnedByNpcTypeID(294341) then
