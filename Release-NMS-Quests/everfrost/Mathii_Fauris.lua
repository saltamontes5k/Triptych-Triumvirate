...
function event_say(e)
  if not prog.gate_stage(e.other, "DoN", "Mathii Fauris says, 'You are not ready for the menagerie yet, friend. Prove yourself against the elemental gods of the planes first.'") then
    return
  end
